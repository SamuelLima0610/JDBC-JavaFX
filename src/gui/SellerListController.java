...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableView<Seller> tableSeller;
	...
	private void initializeNodes() {
		...
		tableSeller.prefHeightProperty().bind(stage.heightProperty());
	}
	...
	private void createDialogForm(Seller obj, Stage parentStage, String absolute) {
		try {
		...
		tableColumnREMOVE.setCellFactory(param -> new TableCell<Seller, Seller>() {
			...
			private void removeEntity(Seller obj) {
				...
				if (result.get() == ButtonType.OK) {
					...
					try {
						service.delete(obj);
						SellerListController.this.updateTableView();
					}
					catch (DbException e) {
